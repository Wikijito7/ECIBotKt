...
class DisconnectCommandTest {
    ...
    @Test
    fun `Given interaction When onExecute is called Then execute disconnect command`() = runTest {
        // Given
    ...
    fun `Given invalid interaction When onExecute is called Then throw exception`() = runTest {
        ...
        // Then - stop should not be called because exception is thrown before
        coVerify(exactly = 0) {
            guildLavaPlayerService.stop()
        }
    }
